# https://dash.gallery/dash-deck-explorer/pdk-views
import dash
import dash_deck
...
mapbox_api_token = "pk.eyJ1IjoieGluZWYiLCJhIjoiY2p4eHJ5Mnl2MDJlYTNtazRyaHR6bDVxZiJ9.5XeA60t2X8ov8R5zoC0gwg"
...
app.layout = html.Div(
    dash_deck.DeckGL(
        r.to_json(), id="deck-gl", tooltip=TOOLTIP_TEXT, mapboxKey=mapbox_api_token#r.mapbox_key
    )
)
